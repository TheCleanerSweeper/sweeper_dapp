...
shadow-md cursor-default focus:outline-none focus-visible:ring-2 focus-visible:ring-opacity-75
...
focus-visible:border-indigo-500 sm:text-sm"
          ...
          >
            <Listbox.Options
              className="absolute w-full py-1 mt-1 overflow-auto text-base bg-white rounded-md
              ...
              {people.map((coin) => (
                ...
                >
                  {(
                    ...
                    <>
                      <span className={`${selected ? 'font-medium' : 'font-normal'} block truncate`}>{people}</span>
                      {selected ? (
                        <span
