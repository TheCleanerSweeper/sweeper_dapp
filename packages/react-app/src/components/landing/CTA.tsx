        ...
        >
          ...
          >
            ...
            <p className="text-lg text-white">
              To join SweeperDAO and have a vote for which tokens should be burned and for how much $SWEEP along with
              other protocol parameters, all you need to do is buy $SWEEP and hold onto it.
            </p>
          </div>
        </div>
      </div>
